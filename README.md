...
Excelsis Helper 1.4.16 is an open-source Windows workflow companion
...
- [Windows installer](https://github.com/simonsystem609/ExcelsisHelper/releases/download/excelsis-helper-v1.4.16/ExcelsisHelper-1.4.16-Setup.exe)
- [Release notes and all assets](https://github.com/simonsystem609/ExcelsisHelper/releases/tag/excelsis-helper-v1.4.16)
- [Exact corresponding-source archive](https://github.com/simonsystem609/ExcelsisHelper/releases/download/excelsis-helper-v1.4.16/ExcelsisHelper-1.4.16-source.zip)
- [SHA-256 checksums](SHA256SUMS.txt)
- [Licensing and security audit](AUDIT-1.4.16.md)
...
This update integrates the Radius outline-corner and angle-prompt fixes,
correct macro module routing, opening completed DXF/BOM export folders, and
an interactive setup warning with Retry/Later when macro updates are locked.
Silent setup stays non-interactive. Existing assembly backup, Work Logger,
viewport thumbnails and read-only previews remain. All nine SWPs have matching
editable sources and neutral host metadata. Older immutable releases and Git
revisions retain their original metadata; see the audit for testing limits.

## Source and build

The exact expanded corresponding source is committed under
[`source/ExcelsisHelper-1.4.16/`](source/ExcelsisHelper-1.4.16/).
...
See
[`docs/BUILDING.md`](source/ExcelsisHelper-1.4.16/docs/BUILDING.md)
