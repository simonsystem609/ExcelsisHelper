...
This inventory covers Excelsis Helper 1.4.9.
...
The installer contains `.swp` macro-project forms of these eight project-owned
macros. The project-authored VBA is created or converted and saved through the
SOLIDWORKS macro editor from the corresponding reviewed `.swb` source. Reviewed
SWB source and the build-ready SWP release inputs are both included.
