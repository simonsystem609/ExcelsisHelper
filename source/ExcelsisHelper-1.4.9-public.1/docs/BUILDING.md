...
upstream checksums verify those inputs. Electron 42.9.0 has no npm lifecycle
...
- dist\Excelsis Helper-Setup-1.4.9.exe
- dist\Excelsis Helper-Setup-1.4.9.exe.blockmap
- dist\win-unpacked\
...
~~~powershell
Get-FileHash -Algorithm SHA256 '.\dist\Excelsis Helper-Setup-1.4.9.exe'
Get-AuthenticodeSignature '.\dist\Excelsis Helper-Setup-1.4.9.exe'
