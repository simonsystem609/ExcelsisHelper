...
- dist\Excelsis Helper-Setup-1.4.3.exe
- dist\Excelsis Helper-Setup-1.4.3.exe.blockmap
- dist\win-unpacked\
...
~~~powershell
Get-FileHash -Algorithm SHA256 '.\dist\Excelsis Helper-Setup-1.4.3.exe'
Get-AuthenticodeSignature '.\dist\Excelsis Helper-Setup-1.4.3.exe'
