...
contextBridge.exposeInMainWorld("excelsisAutomation", {
  ...
  retryRecentDocThumbnail: (docPath) => ipcRenderer.invoke("automation:retry-recent-doc-thumbnail", docPath),
  ...
  copyDocumentPath: (docPath, options) => ipcRenderer.invoke("automation:copy-document-path", docPath, options),
